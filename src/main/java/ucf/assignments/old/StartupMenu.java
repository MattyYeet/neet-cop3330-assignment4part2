    ...
    @FXML
     void newBox(){
        ComboBox<String> newCombo = new ComboBox<>();
            newCombo.getItems().add("List");
            newCombo.getItems().add("Item");
    }

    @FXML
    void deleteBox(){
        ComboBox<String> deleteCombo = new ComboBox<>();
        deleteCombo.getItems().add("List");
        deleteCombo.getItems().add("Item");
    }
